  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      'object' ===
        ...
        (((o = document.createElement ('style')).className = i), o.appendChild (
      ...
      function C (e, t) {
        ...
        this.runActions = function (e, o) {
          c[t].classList.add (x), i[t].classList.add (g), s[t].removeChild (
            s[t].firstChild
      ...
      function F (e, t) {
        ...
        (this.handleImageLoad = function (e) {
          ...
          i.maxYoutubeDimensions &&
            ((e = i.maxYoutubeDimensions.width), (t =
              i.maxYoutubeDimensions.height)), s.runActions (e, t);
      ...
      function T (e, t) {
        var n = e.collections.sourceLoadHandlers,
          ...
          s = e.props.sources;
        (r[t] = document.createElement ('img')), A (e, t, y), (r[t].src =
          s[t]), (r[t].onload = n[t].handleImageLoad), I (e, t), i[
          t
        ].appendChild (r[t]);
      }
      function E (e, t) {
        var n = e.collections.sourceLoadHandlers,
          ...
          c = s.sources,
          a = s.videosPosters;
        (r[t] = document.createElement ('video')), A (e, t, y), (r[t].src =
          c[t]), (r[t].onloadedmetadata = function (e) {
          n[t].handleVideoLoad (e);
        }), (r[t].controls = !0), I (e, t), a[t] && (r[t].poster = a[t]);
        var l = document.createElement ('source');
        (l.src = c[t]), r[t].appendChild (l), setTimeout (
      ...
      function N (e, t) {
        var n = e.collections.sourceLoadHandlers,
          ...
          c = e.props.sources;
        (i[t] = document.createElement ('iframe')), A (
          e,
          t,
          ''.concat (y, ' ').concat (r, 'youtube-iframe')
        ), (i[t].src = 'https://www.youtube.com/embed/'.concat (
          c[t].match (
            /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/
          )[2],
          '?enablejsapi=1'
        )), (i[t].allowFullscreen = !0), I (e, t), s[t].appendChild (i[t]), n[
          t
        ].handleYoutubeLoad ();
      }
      function W (e, t) {
        var n = e.collections.sourceLoadHandlers,
          ...
          i = o.sourceAnimationWrappers,
          s = e.props.sources;
        (r[t] = s[t]), A (e, t, ''.concat (r[t].className, ' ').concat (y)), i[
          t
        ].appendChild (r[t]), n[t].handleCustomLoad ();
      }
      function z (e, t) {
        var n = e.elements,
          o = n.sources,
        ...
        e.props.sources;
        (o[t] = document.createElement ('div')), (o[t].className = ''
          .concat (r, 'invalid-file-wrapper ')
          .concat (a)), (o[t].innerHTML = 'Invalid source'), i[
          t
        ].classList.add (g), i[t].appendChild (o[t]), s[t].removeChild (
          s[t].firstChild
        );
      }
      function M (e) {
      ...
      function P () {
        ...
        function r () {
          if (4 !== n.readyState) {
            if (2 === n.readyState) {
              var e;
              switch (o.getTypeFromResponseContentType (
        ...
        (this.setUrlToCheck = function (t) {
          ...
          (t = i), ((n = new XMLHttpRequest ()).onreadystatechange = r), n.open (
            'GET',
            e,
            !0
          ), n.send ();
      ...
      function O (e, t, n, o) {
        ...
        i.setAttributeNS (null, 'width', t), i.setAttributeNS (
          null,
          'height',
          t
        ...
        return s.setAttributeNS (
          ...
          'class',
          ''.concat (r, 'svg-path')
        ), s.setAttributeNS (null, 'd', o), i.appendChild (s), e.appendChild (
          i
        ), i;
      }
      function R (e, t) {
        ...
        return (n.className = ''
          ...
          .concat (a)), (n.title = t), e.appendChild (n), n;
      }
      function D (e, t) {
        var n = document.createElement ('div');
        (n.className = ''.concat (r, 'toolbar')), t.appendChild (n), (function (
          e,
          t
        ) {
          ...
          (n.enterFullscreen = function () {
            (r.isFullscreenOpen = !0), (s.title =
              'Exit fullscreen'), c.setAttributeNS (
              null,
              'width',
              '24px'
            ), c.setAttributeNS (null, 'height', '24px'), c.setAttributeNS (
              null,
              'viewBox',
              '0 0 950 1024'
            ...
            (r.isFullscreenOpen = !1), (s.title =
              'Enter fullscreen'), c.setAttributeNS (
              null,
              'width',
              '20px'
            ), c.setAttributeNS (null, 'height', '20px'), c.setAttributeNS (
              null,
              'viewBox',
              '0 0 18 18'
          ...
          var n = R (t, 'Close');
          (n.onclick = e.core.lightboxCloser.closeLightbox), O (
            n,
            '20px',
            '0 0 24 24',
      ...
      function j (e) {
        ...
        (o.className = ''.concat (r, 'nav')), n.appendChild (o), D (
          e,
          o
        ), t.length > 1 &&
          (function (e, t) {
            ...
            (u.innerHTML = o.length), i.appendChild (s), s.appendChild (
              c
            ), s.appendChild (l), s.appendChild (u), t.appendChild (
              i
            ), setTimeout (function () {
      ...
      function B (e, t, n, o) {
        ...
        (s.className = ''
          .concat (f, ' ')
          .concat (f, '-')
          .concat (n)), (s.title = ''.concat (
          i,
          ' slide'
        )), (s.onclick = t), (function (e, t) {
          var n = document.createElement ('div');
          (n.className = ''.concat (p, ' ').concat (a)), O (
            n,
            '20px',
            '0 0 20 20',
            t
      ...
      function V (e) {
        ...
        (this.isLightboxFadingOut = !1), (this.runActions = function () {
          (t.isLightboxFadingOut = !0), a.container.classList.add (
            v
          ), i.removeListeners (), u.exitFullscreenOnClose &&
            c.isFullscreenOpen &&
            r.exitFullscreen (), setTimeout (function () {
      ...
      function Y (e) {
        ...
        (a.changeTo = function (e) {
          (f.current = e), d.updateStageIndexes (), i.setSlideNumber (
            e + 1
          ), l.displaySourcesWhichShouldBeDisplayed ();
        }), (a.jumpTo = function (e) {
          var t = f.current;
          a.changeTo (e), c.removeFromEachElementClassIfContains (
            'sourceMainWrappers',
            u
          ), U (p[t], g), U (p[t], h), p[t].classList.add (m), U (p[e], g), U (
            p[e],
            m
          ), p[e].classList.add (h), v (), r[
            e
      ...
      function q (e) {
        ...
        this.runActionsForEvent = function (e) {
          ...
          n.container.contains (n.slideSwipingHoverer) ||
            n.container.appendChild (n.slideSwipingHoverer), (t =
            n.container), (c = s), (a = t.classList).contains (c) ||
            a.add (c), (o.swipedX = e.screenX - o.downScreenX), i (
            r.current,
            'zero'
      ...
      function G (e) {
        ...
        (this.runPositiveSwipedXActions = function () {
          void 0 === r.previous ||
            (i ('positive'), n.changeTo (r.previous)), i ('zero');
        }), (this.runNegativeSwipedXActions = function () {
          void 0 === r.next || (i ('negative'), n.changeTo (r.next)), i (
            'zero'
          );
        });
        var i = function (e) {
      ...
      function K (e) {
        ...
        (this.runNoSwipeActions = function () {
          $ (n.container, n.slideSwipingHoverer), r.isSourceDownEventTarget ||
            t.closeLightbox (), (r.isPointering = !1);
      ...
      function Z (e) {
        var t, n, o;
        (n = (t = e).core.classFacade), (o =
          t.elements), (n.removeFromEachElementClassIfContains = function (
          e,
          t
        ) {
          ...
          (n.enterFullscreen = function () {
            ...
            t.exitFullscreen (), document.exitFullscreen
          ...
          o.listener = function (e) {
            'VIDEO' !== e.target.tagName &&
              e.preventDefault (), (i.isPointering = !0), (i.downScreenX =
              e.screenX), (i.swipedX = 0);
            var t = r[s.current];
            t && t.contains (e.target)
              ? (i.isSourceDownEventTarget = !0)
              : (i.isSourceDownEventTarget = !1), n.removeFromEachElementClassIfContains (
              'sourceMainWrappers',
              u
            );
          };
          ...
          r.runActions = function () {
            innerWidth < 992
              ...
              : (i.maxSourceWidth = 0.9 * innerWidth), (i.maxSourceHeight =
              0.9 * innerHeight);
            for (var e = 0; e < c.sources.length; e++)
              U (s[e], u), e !== a.current && n[e].negative (), o[e] &&
                o[e].adjustSize ();
          };
        }) (e);
      }
      function ee (e) {
        ...
        var o = (function () {
          ...
          return (t.visibility = 'hidden'), (t.width =
            '100px'), (t.msOverflowStyle = 'scrollbar'), (t.overflow =
            'scroll'), e;
        }) (),
          r = (function () {
        ...
        var c = i - s;
        return t ||
          localStorage.setItem ('fslightbox-scrollbar-width', c.toString ()), c;
      }
      function te (e) {
        ...
        (n.isInitialized = !0), (n.scrollbarWidth = ee (e)), (function (e) {
          for (
            ...
            t[r] = o (X, [r]);
        }) (e), Z (e), (o.container = document.createElement (
          'div'
          ...
          .concat (g)), (function (e) {
          var t = e.elements;
          (t.slideSwipingHoverer = document.createElement (
            'div'
          ...
          (r.className = ''
            .concat (d, ' ')
            .concat (c)), n.container.appendChild (r), r.addEventListener (
            'pointerdown',
            t.listener
      ...
      function ne (e) {
        ...
        i.open = function () {
          var o = arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : 0;
          (h.current = o), p.isInitialized
            ? r.dispatch ('onShow')
            : te (
                e
              ), u.updateStageIndexes (), a.displaySourcesWhichShouldBeDisplayed (), n.setSlideNumber (
            o + 1
          ), document.body.appendChild (
            f.container
          ), document.documentElement.classList.add (
            l
          ), c.addRecompense (), s.attachListeners (), d.runActions (), t[
            h.current
          ].zero (), r.dispatch ('onOpen');
        };
      }
      function oe (e, t, n) {
        return (oe = re ()
          ...
          var e = document.getElementsByTagName ('a'),
            t = function (t) {
              ...
              '#' === o.charAt (0)
                ...
                : (r = o), fsLightboxInstances[n].props.sources.push (
                r
      ...
      (window.FsLightbox = function () {
        ...
        for (var e in fsLightboxInstances) {
          ...
          (fsLightboxInstances[e] = new FsLightbox ()), (fsLightboxInstances[
            e
          ].props = t), (fsLightboxInstances[
            e
          ].props.sources = []), (fsLightboxInstances[e].elements.a = []);
        }
        ae ();
      });
    },
